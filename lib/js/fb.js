...
function setProfile() {
	document.getElementById("profile").src= "http://graph.facebook.com/"+ userID + "/picture?type=square"
	console.log("Image: " + "http://graph.facebook.com/"+ userID + "/picture?type=large")
}